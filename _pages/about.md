...
I am now a postdoc research fellow working with [Prof. Jiannong Cao](https://www4.comp.polyu.edu.hk/~csjcao/) and [Prof. Minyi Guo](https://cs.sjtu.edu.cn/~guo-my/). I received my Ph.D. degree from Department of Computer Science and Engineering, Shanghai Jiao Tong University in 2024, supervised by [Prof. Minyi Guo](https://cs.sjtu.edu.cn/~guo-my/) and [Prof. Quan Chen](https://www.cs.sjtu.edu.cn/~chen-quan/). My research interests include: Cloud-native systems, LLM inference and fine-tuning, Disaggregated datacenters, etc. If you are interested in my research, feel free to email me.
...
<ul>
<li><div class="pubtitle">ARXIV</div> &nbsp;Jinyuan Chen^, <span class="font-bold">Jiuchen Shi^</span>, Quan Chen*, Minyi Guo. "Kairos: Low-latency Multi-Agent Serving with Shared LLMs and Excessive Loads in the Public Cloud". <a href="http://arxiv.org/abs/2508.06948">[paper]</a></li>
...
<!-- <li><div class="pubtitle">ARXIV</div> &nbsp;Fanrong Du^, <span class="font-bold">Jiuchen Shi^</span>, Quan Chen*, Li Li, Minyi Guo. "A Microservice Graph Generator with Production Characteristics". <a href="https://arxiv.org/abs/2412.19083">[paper]</a></li> -->
</ul>
...
<li><div class="pubtitle">TC 2026</div> &nbsp;<span class="font-bold">Jiuchen Shi</span>, Zhixin Tong, Quan Chen*, Kaihua Fu, Liwei Song, Pengfei Huang, Yinuo Li, Mosong Zhou, Mingliang Yin, Deze Zeng, Xiaohua Tian, Minyi Guo. "Holistic Orchestration of Resource Reservation for Reducing Operation Costs in Geo-distributed Cloud". <span class="font-bold">(CCF-A)</span>. <a href="xxx">[paper]</a></li>
...
<li><div class="pubtitle">ICCD 2026</div> &nbsp;Yicheng Chen, <span class="font-bold">Jiuchen Shi*</span>, Yixiao Wang, Quan Chen*, Pu Pang, Minyi Guo. "GraphPlan: Low-Latency Multi-Graph NPU LLM Inference for Variable-Length Prompts". <span class="font-bold">(CCF-B)</span>. <a href="xxx">[paper]</a></li>
...
<li><div class="pubtitle">APPT 2025</div> &nbsp;Jinyuan Chen, <span class="font-bold">Jiuchen Shi*</span>, Quan Chen, Lin Gu, Minyi Guo. "Veyth: Adaptive Container Placement for Optimizing Cross-Server Network Traffic of Microservice Applications". <span class="font-bold">(CCF-C)</span>. <a href="https://link.springer.com/chapter/10.1007/978-981-95-1021-4_15">[paper]</a></li>
<li><div class="pubtitle">APPT 2025</div> &nbsp;Ruogang Ma, <span class="font-bold">Jiuchen Shi*</span>, Quan Chen, Minyi Guo. "Comber: QoS-aware and Efficient Deployment for Co-located Microservices and Best-Effort Tasks in Disaggregated Datacenters". <span class="font-bold">(CCF-C)</span>. <a href="https://link.springer.com/chapter/10.1007/978-981-95-1021-4_33">[paper]</a></li>
...
<li><div class="pubtitle">USENIX ATC 2023</div> &nbsp;<span class="font-bold">Jiuchen Shi</span>, Hang Zhang, Zhixin Tong, Quan Chen*, Kaihua Fu, Minyi Guo*. "Nodens: Enabling Resource Efficient and Fast QoS Recovery of Dynamic Microservice Applications in Datacenters". <span class="font-bold">(CCF-A)</span>. <a href="https://shijiuchen.github.io/files/Nodens.pdf">[paper]</a></li>
...
**Patents:**
<ul>
<li>基于跨地域的微服务过量负载调度系统、方法及设备. 发明人: 陈全, 过敏意, <span class="font-bold">史久琛</span>. 专利号: ZL 2022 1 0583583.X. 授权公开日: 2023年11月17日. 授权公告号: CN 115190121 B. 已授权</li>
<li>面向动态性特征的微服务应用优化资源管理系统及方法. 发明人: 陈全, 过敏意, <span class="font-bold">史久琛</span>, 仝志欣, 张行. 专利号: ZL 2023 1 0754097.4. 授权公告日: 2026年07月28日. 授权公告号: CN 119203047 B. 已授权</li>
</ul>

Honors & Awards
======
<!-- super xxx-->
+ CCF Computility 2026 Outstanding Doctoral Dissertation Award (2026)
